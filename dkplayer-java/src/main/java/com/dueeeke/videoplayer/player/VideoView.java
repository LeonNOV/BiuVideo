...
public class VideoView<P extends AbstractPlayer> extends FrameLayout implements MediaPlayerControl, AbstractPlayer.PlayerEventListener {
    ...
    //--------- data sources ---------//
    protected String mVideoUrl;//当前播放视频的地址
    protected String mAudioUrl;//当前播放视频的地址
    ...
    protected boolean startPlay() {
        ...
        if (mProgressManager != null) {
            mCurrentPosition = mProgressManager.getSavedProgress(mVideoUrl);
        }
        initPlayer();
        addDisplay();
        startPrepare(false);
    ...
    protected boolean prepareDataSource() {
        if (mAssetFileDescriptor != null) {
            ...
            return true;
        } else if (!TextUtils.isEmpty(mVideoUrl) || !TextUtils.isEmpty(mAudioUrl) ) {
            mMediaPlayer.setDataSource(mVideoUrl, mAudioUrl, mHeaders);
            return true;
        }
        return false;
    }
    ...
    protected void saveProgress() {
        if (mProgressManager != null && mCurrentPosition > 0) {
            ...
            mProgressManager.saveProgress(mVideoUrl, mCurrentPosition);
        }
    }
    ...
    public void onCompletion() {
        ...
        if (mProgressManager != null) {
            //播放完成，清除进度
            mProgressManager.saveProgress(mVideoUrl, 0);
        }
     ...
     * @param headers 请求头
     */
    public void setUrl(String videoUrl, String audioUrl, Map<String, String> headers) {
