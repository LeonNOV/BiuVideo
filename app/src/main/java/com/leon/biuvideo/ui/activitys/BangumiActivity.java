...
public class BangumiActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initValue() {
        ...
        bangumi_imageView_favoriteMark.setImageResource(isHaveLocalOrder ? R.drawable.icon_video_favorite : R.drawable.ic_collect);
...
//                            Play playWithDownload = videoWithFlvParser.parseMedia(null, cid, true);
            ...
            case R.id.bangumi_linearLayout_addFavorite:
                ...
                if (isHaveLocalOrder) {
                    ...
                    if (operatingStatus) {
                        bangumi_imageView_favoriteMark.setImageResource(R.drawable.ic_collect);
