...
public class BangumiDetailDialog extends AlertDialog {
    ...
    private void initView() {
        ...
        bindingUtils.setImage(R.id.bangumi_detail_dialog_imageView_cover, bangumi.cover, ImagePixelSize.COVER)
                ...
                .setText(R.id.bangumi_detail_dialog_textView_bangumiState, bangumi.eps.size() == bangumi.epSize ? "已完结" : "连载中")
                .setText(R.id.bangumi_detail_dialog_textView_epSize, "全" + bangumi.epSize + "话")
