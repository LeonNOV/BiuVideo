...
public class VideoResultFragment extends Fragment {
    ...
    public VideoResultFragment(String keywordCoded) {
        this.keywordCoded = keywordCoded;
    }
    ...
    private void initValue() {
        ...
        videos = videoParser.videoParse(keywordCoded, pageNum, OrderType.DEFAULT);
    ...
    public List<UpVideo> getVideos(int pageNum) {
        List<UpVideo> temp = videoParser.videoParse(keywordCoded, pageNum, OrderType.DEFAULT);
