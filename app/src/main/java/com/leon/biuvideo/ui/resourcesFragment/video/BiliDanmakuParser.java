...
/**
 * @Author copy from BiliBili
 * @Time 2021/4/18
 * @Desc 解析弹幕数据并返回BaseDanmakuParser对象
 *      该类并不为本人所写，且来自于{https://github.com/bilibili/DanmakuFlameMaster/blob/master/Sample/src/main/java/com/sample/BiliDanmukuParser.java}
 */
