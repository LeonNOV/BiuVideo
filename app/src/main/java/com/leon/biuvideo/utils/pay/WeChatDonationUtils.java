 ...
 * @Desc 微信捐赠
 */
public class WeChatDonationUtils {
    private static final String TAG = WeChatDonationUtils.class.getSimpleName();
     ...
     * 微信捐赠
     */
    public static void donateViaWeiXin(Activity activity, File qrSCodeFile) {
        sendPictureStoredBroadcast(activity, qrSCodeFile);
        openWeChatQrScan(activity);
    }
     ...
     * 打开微信扫一扫
     */
    private static void openWeChatQrScan(@NonNull Activity activity) {
