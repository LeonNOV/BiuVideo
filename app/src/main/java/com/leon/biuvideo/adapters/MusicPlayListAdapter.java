...
public class MusicPlayListAdapter extends RecyclerView.Adapter<MusicPlayListAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.music_textView_playList_name.setText(musicPlayList.musicName);
        holder.music_textView_playList_author.setText(musicPlayList.musicAuthor);
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView music_textView_playList_name, music_textView_playList_author;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            music_relativeLayout.setOnClickListener(v -> {
                if (onItemClickListener != null) {
                    ...
                    music_textView_playList_name = itemView.findViewById(R.id.music_textView_playList_name);
