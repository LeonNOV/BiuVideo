...
public class SearchResultVideoAdapter extends BaseAdapter<SearchResultVideo> {
    ...
    public void onBindViewHolder(@NonNull BaseViewHolder holder, int position) {
        ...
        holder.setImage(R.id.search_result_item_video_cover, searchResultVideo.cover, ImagePixelSize.COVER)
                .setText(R.id.search_result_item_video_duration, searchResultVideo.duration)
                .setText(R.id.search_result_item_video_title, searchResultVideo.title)
